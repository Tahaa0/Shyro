...
window.onload = function(){
  ...
  console.log('yes');
	if(STEP_URLS.indexOf(pathParts[pathParts.length-1].trim()) != -1){
		console.log('NIB');
		/*var productIDS = [$("#cfAR input[name='purchase[product_id]']:first").val(),$("#cfAR input[name='purchase[product_id]']:last").val()];
  $("#cfAR input[name='purchase[product_id]']:last, #cfAR input[name='purchase[product_ids][]']:last").remove();  
  ...
  /*
    ...
    head.appendChild(styleElement);
      ...
      ccTab.on('click',function(){
        //$("#cfAR input[name='purchase[product_id]']").val(productIDS[0]);
        //$("#cfAR input[name='purchase[product_ids][]']").val(productIDS[0]);
        ppBody.slideUp(200);
      ...
      ppTab.click(function(){
        //$("#cfAR input[name='purchase[product_id]']").val(productIDS[1]);
        //$("#cfAR input[name='purchase[product_ids][]']").val(productIDS[1]);
        ccBody.slideUp(200);
