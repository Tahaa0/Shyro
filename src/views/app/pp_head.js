window.onload = function(){
  ...
  for(var i=0;i<STEP_URLS.length;i++){
    ...
    styleElement.innerHTML = styleCode+customStyle+radioStyle;
    ...
    console.log(parDOM);
    var ccTab = $('<div id="ccTab" class="a_tab"><label class="radlab"><input type="radio" checked="checked" name="ispp" id="ccRadio"><span class="checkmark"></span></label><span class="ttl">Credit Card</span></div>');
    var ccBody = $('<div id="ccBody" class="a_body"></div>');
    var ppTab = $('<div id="paypalTab" class="a_tab"><label class="radlab"><input type="radio" name="ispp" id="ppRadio"><span class="checkmark"></span></label><span class="ttl">PayPal</span></div>');
